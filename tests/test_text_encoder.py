...
text_encoder_dims = {'stabilityai/stable-diffusion-xl-base-1.0/text_encoder': 768, 'stabilityai/stable-diffusion-xl-base-1.0/text_encoder_2': 1280, 'intfloat/e5-large-v2': 1024}
text_encoders = ['stabilityai/stable-diffusion-xl-base-1.0/text_encoder', 'stabilityai/stable-diffusion-xl-base-1.0/text_encoder_2', 'intfloat/e5-large-v2']
...
@pytest.mark.parametrize('tokenizer_names,text_encoder_names', [t for t in zip(tokenizer_combins, text_encoder_combins)])
